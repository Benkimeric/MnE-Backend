...
class HouseholdsController {
  ...
  static async createHouseholds(req, res) {
    try {
      ...
      const household = await HouseholdHelper.createHousehold({ ...body, uniqueId });
  ...
  static async updateHousehold(req, res) {
    try {
      ...
      const household = await HouseholdHelper.updateHousehold(body, householdId);
      return ResponseHandler.handleSuccess(
  ...
  static async restoreHousehold(req, res) {
    try {
      ...
      const message = household
        ? 'Household restored successfully' : 'Household with the given Id does not exist';
